// Freight Trip client controller. Module path: cargoa.cargoa.api
...
function _call(frm, method, open_doctype) {
	frappe.call({ method: method, args: { trip: frm.doc.name }, freeze: true,
		callback: function (r) { if (r.message) { frm.refresh(); frappe.set_route("Form", open_doctype, r.message); } } });
}
